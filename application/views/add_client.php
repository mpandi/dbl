...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url();?>clients/create"><i class="fa fa-user-plus"></i> Create New</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Clients<small>Add Client</small>
      </h1>
      <ol class="breadcrumb">
...
var fname = $('#fname').val(),
    ...
    if(!error){
     ...
     swal.showLoading();
     $.post("<?php echo base_url(); ?>clients/add", {fname:fname, email: email, phone:phone, address:address, city:city, state:state, country:country, postal:postal, assignee:assignee}, function(message){
