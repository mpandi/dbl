...
class Clients extends CI_Controller {
	public function __construct() {
		parent::__construct();
		// Load database
		$this->load->model('clients_database');
...
public function view(){
        $data['users_data'] = $this->clients_database->read();
	     if($data['users_data'] != false) {
		   $this->load->view('view_clients',$data);
		  } 
	     else {
		   $data = array(
		   'error_message' => 'No clients at the moment...'
		  );
		  $this->load->view('view_clients', $data);
		}
     }
...
public function add(){ 
		...
		echo $this->clients_database->insert($data);		
   }   
